...
final class WyomingNsd {
    private static final String TAG = "EdgeTtsNsd";
    ...
    void register(String serviceName, int port) {
        ...
        serviceInfo.setAttribute("name", "HA Edge TTS");
        serviceInfo.setAttribute("description", "Edge TTS Wyoming server on Ava");
