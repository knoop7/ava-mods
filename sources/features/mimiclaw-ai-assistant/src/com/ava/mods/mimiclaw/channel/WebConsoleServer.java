...
public class WebConsoleServer {
    ...
    private String buildPage(boolean authed, String sessionId) {
        ...
        return "<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover'>"
            ...
            + "<div class='inlineActions'><button class='inlineMiniBtn primary' type='button' onclick='saveCurrentProfile()'>Save Profile</button><button class='inlineMiniBtn' type='button' onclick='createProfileDraft()'>New Blank Profile</button><button class='inlineMiniBtn' type='button' onclick='deleteCurrentProfile()'>Delete</button></div>"
