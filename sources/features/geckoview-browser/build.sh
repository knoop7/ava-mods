...
# Compile Java sources (no GeckoView dependency - all reflection-based)
echo "Compiling Java sources..."
javac -source 1.8 -target 1.8 \
    -cp "$ANDROID_JAR" \
    -d $BUILD_DIR \
    src/com/ava/mods/geckoview/*.java
...
"$D8_TOOL" --output $BUILD_DIR $BUILD_DIR/com/ava/mods/geckoview/*.class
